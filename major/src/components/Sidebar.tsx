...
function Sidebar() {
  ...
  return (
    <div>
      <section className='sticky left-0 top-0 flex h-screen w-fit flex-col justify-between bg-black border-r border-gray-700 p-6 pt-28 text-white max-sm:hidden lg:w-[264px]'>
